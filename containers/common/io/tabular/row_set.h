...
#ifndef CONFIDENTIAL_FEDERATED_COMPUTE_CONTAINERS_COMMON_IO_TABULAR_ROW_SET_H_
#define CONFIDENTIAL_FEDERATED_COMPUTE_CONTAINERS_COMMON_IO_TABULAR_ROW_SET_H_
...
#endif  // CONFIDENTIAL_FEDERATED_COMPUTE_CONTAINERS_COMMON_IO_TABULAR_ROW_SET_H_
