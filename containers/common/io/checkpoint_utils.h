...
#ifndef CONFIDENTIAL_FEDERATED_COMPUTE_CONTAINERS_COMMON_IO_CHECKPOINT_UTILS_H_
#define CONFIDENTIAL_FEDERATED_COMPUTE_CONTAINERS_COMMON_IO_CHECKPOINT_UTILS_H_
...
#endif  // CONFIDENTIAL_FEDERATED_COMPUTE_CONTAINERS_COMMON_IO_CHECKPOINT_UTILS_H_
