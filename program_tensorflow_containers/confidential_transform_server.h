...
#ifndef CONFIDENTIAL_FEDERATED_COMPUTE_LEARNING_CONTAINERS_TENSORFLOW_PROGRAM_EXECUTOR_TEE_CONFIDENTIAL_TRANSFORM_SERVER_H_
#define CONFIDENTIAL_FEDERATED_COMPUTE_LEARNING_CONTAINERS_TENSORFLOW_PROGRAM_EXECUTOR_TEE_CONFIDENTIAL_TRANSFORM_SERVER_H_
...
// ConfidentialTransform service for tensorflow program executor TEE.
class TensorflowProgramExecutorTeeConfidentialTransform final
...
#endif  // CONFIDENTIAL_FEDERATED_COMPUTE_LEARNING_CONTAINERS_TENSORFLOW_PROGRAM_EXECUTOR_TEE_CONFIDENTIAL_TRANSFORM_SERVER_H_