...
# Bundle from the Docker container and exports it to BINARY_OUTPUTS_DIR.
set -e
...
${WORKSPACE_DIR}/${SCRIPTS_RELATIVE_DIR}/docker_run.sh /bin/bash ${SCRIPTS_RELATIVE_DIR}/bazel_build_with_deps.sh "$@"
